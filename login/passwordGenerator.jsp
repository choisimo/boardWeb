...
<link rel="stylesheet" href="<%=request.getContextPath()%>/assets/css/login/passwordGen.css">
...
<script src="<%=request.getContextPath()%>/assets/js/login/passwordGen.js"></script>
</html>