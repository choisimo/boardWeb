				...
				<div class="board_post_wrapper">
					<div class="board_post_inputgroup">
						...
						<div class="board_type_category">
							...
							<textarea id="editor" class="form-control" placeholder="글 내용" name="post_content" maxlength="60000" style="height: 350px"></textarea>
							...
							<button type="button" id="uploadFileBtn" onclick="javascript:uploadFile()"></button>
							<input type="hidden" name="post_writer" value="<%=mem_id%>">
							<div class="file_input_previews" id="file_previews"></div>
						<input type="reset" class="board_post_reset_btn1" value="다시쓰기">
						<input type="submit" class="board_post_btn1" value="글쓰기">
				</div>
			</div>
		</form>
		</div>
